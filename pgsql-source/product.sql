...
CREATE SEQUENCE "public"."t_attachment_desc_iid_seq"
 ...
 START 5
 CACHE 1;
SELECT setval('"public"."t_attachment_desc_iid_seq"', 5, true);
...
CREATE SEQUENCE "public"."t_attachment_iid_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"public"."t_attachment_iid_seq"', 4, true);
...
CREATE SEQUENCE "public"."t_attribute_key_ikeyid_seq"
 ...
 START 3333
 CACHE 1;
SELECT setval('"public"."t_attribute_key_ikeyid_seq"', 3333, true);
...
CREATE SEQUENCE "public"."t_attribute_key_name_iid_seq"
 ...
 START 2273
 CACHE 1;
SELECT setval('"public"."t_attribute_key_name_iid_seq"', 2273, true);
...
CREATE SEQUENCE "public"."t_attribute_value_ivalueid_seq"
 ...
 START 31544
 CACHE 1;
SELECT setval('"public"."t_attribute_value_ivalueid_seq"', 31544, true);
...
CREATE SEQUENCE "public"."t_attribute_value_name_ikeyid_seq"
 ...
 START 31936
 CACHE 1;
SELECT setval('"public"."t_attribute_value_name_ikeyid_seq"', 31936, true);

-- ----------------------------
-- Sequence structure for t_category_attributekey_relation_iid_seq
-- ----------------------------
DROP SEQUENCE "public"."t_category_attributekey_relation_iid_seq";
CREATE SEQUENCE "public"."t_category_attributekey_relation_iid_seq"
 INCREMENT 1
 MINVALUE 1
 MAXVALUE 9223372036854775807
 START 620
 CACHE 1;
SELECT setval('"public"."t_category_attributekey_relation_iid_seq"', 620, true);
...
CREATE SEQUENCE "public"."t_category_backgroundimages_iid_seq"
 ...
 START 22
 CACHE 1;
SELECT setval('"public"."t_category_backgroundimages_iid_seq"', 22, true);
...
CREATE SEQUENCE "public"."t_category_base_iid_seq"
 ...
 START 1774
 CACHE 1;
SELECT setval('"public"."t_category_base_iid_seq"', 1774, true);

-- ----------------------------
-- Sequence structure for t_category_filter_attribute_seq
-- ----------------------------
DROP SEQUENCE "public"."t_category_filter_attribute_seq";
CREATE SEQUENCE "public"."t_category_filter_attribute_seq"
 INCREMENT 1
 MINVALUE 1
 MAXVALUE 9223372036854775807
 START 36
 CACHE 1;
SELECT setval('"public"."t_category_filter_attribute_seq"', 36, true);
...
CREATE SEQUENCE "public"."t_category_label_iid_seq"
 ...
 START 7944
 CACHE 1;
SELECT setval('"public"."t_category_label_iid_seq"', 7944, true);
...
CREATE SEQUENCE "public"."t_category_label_name_iid_seq"
 ...
 START 72
 CACHE 1;
SELECT setval('"public"."t_category_label_name_iid_seq"', 72, true);
...
CREATE SEQUENCE "public"."t_category_label_type_iid_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"public"."t_category_label_type_iid_seq"', 4, true);
...
CREATE SEQUENCE "public"."t_category_name_iid_seq"
 ...
 START 18452
 CACHE 1;
SELECT setval('"public"."t_category_name_iid_seq"', 18452, true);
...
CREATE SEQUENCE "public"."t_category_product_recommend_iid_seq"
 ...
 START 2112
 CACHE 1;
SELECT setval('"public"."t_category_product_recommend_iid_seq"', 2112, true);
...
CREATE SEQUENCE "public"."t_category_website_iid_seq"
 ...
 START 1888
 CACHE 1;
SELECT setval('"public"."t_category_website_iid_seq"', 1888, true);
...
CREATE SEQUENCE "public"."t_daily_deals_iid_seq"
 ...
 START 2716
 CACHE 1;
SELECT setval('"public"."t_daily_deals_iid_seq"', 2716, true);
...
CREATE SEQUENCE "public"."t_google_attribute_key_iid_seq"
 ...
 START 47
 CACHE 1;
SELECT setval('"public"."t_google_attribute_key_iid_seq"', 47, true);
...
CREATE SEQUENCE "public"."t_google_category_base_iid_seq"
 ...
 START 6229
 CACHE 1;
SELECT setval('"public"."t_google_category_base_iid_seq"', 6229, true);
...
CREATE SEQUENCE "public"."t_google_category_relation_iid_seq"
 ...
 START 31
 CACHE 1;
SELECT setval('"public"."t_google_category_relation_iid_seq"', 31, true);
...
CREATE SEQUENCE "public"."t_google_feeds_base_iid_seq"
 ...
 START 23
 CACHE 1;
SELECT setval('"public"."t_google_feeds_base_iid_seq"', 23, true);
...
CREATE SEQUENCE "public"."t_google_filter_attribute_iid_seq"
 ...
 START 61
 CACHE 1;
SELECT setval('"public"."t_google_filter_attribute_iid_seq"', 61, true);
...
CREATE SEQUENCE "public"."t_google_product_category_mapper_iid_seq"
 ...
 START 127
 CACHE 1;
SELECT setval('"public"."t_google_product_category_mapper_iid_seq"', 127, true);
...
CREATE SEQUENCE "public"."t_google_product_detail_iid_seq"
 ...
 START 27
 CACHE 1;
SELECT setval('"public"."t_google_product_detail_iid_seq"', 27, true);
...
CREATE SEQUENCE "public"."t_home_page_show_history_iid_seq"
 ...
 START 2425
 CACHE 1;
SELECT setval('"public"."t_home_page_show_history_iid_seq"', 2425, true);
...
CREATE SEQUENCE "public"."t_inventory_history_iid_seq"
 ...
 START 131273
 CACHE 1;
SELECT setval('"public"."t_inventory_history_iid_seq"', 131273, true);
...
CREATE SEQUENCE "public"."t_merchants_product_iid_seq"
 ...
 START 328887
 CACHE 1;
SELECT setval('"public"."t_merchants_product_iid_seq"', 328887, true);
...
CREATE SEQUENCE "public"."t_product_activity_relation_detail_iid_seq"
 ...
 START 75
 CACHE 1;
SELECT setval('"public"."t_product_activity_relation_detail_iid_seq"', 75, true);
...
CREATE SEQUENCE "public"."t_product_activity_relation_iid_seq"
 ...
 START 33
 CACHE 1;
SELECT setval('"public"."t_product_activity_relation_iid_seq"', 33, true);
...
CREATE SEQUENCE "public"."t_product_attachment_mapper_iid_seq"
 ...
 START 2
 CACHE 1;
SELECT setval('"public"."t_product_attachment_mapper_iid_seq"', 2, true);
...
CREATE SEQUENCE "public"."t_product_base_iid_seq"
 ...
 START 107441
 CACHE 1;
SELECT setval('"public"."t_product_base_iid_seq"', 107441, true);
...
CREATE SEQUENCE "public"."t_product_bundle_sale_iid_seq"
 ...
 START 1979460
 CACHE 1;
SELECT setval('"public"."t_product_bundle_sale_iid_seq"', 1979460, true);
...
CREATE SEQUENCE "public"."t_product_category_mapper_iid_seq"
 ...
 START 267311
 CACHE 1;
SELECT setval('"public"."t_product_category_mapper_iid_seq"', 267311, true);
...
CREATE SEQUENCE "public"."t_product_category_rank_iid_seq"
 ...
 START 4075
 CACHE 1;
SELECT setval('"public"."t_product_category_rank_iid_seq"', 4075, true);
...
CREATE SEQUENCE "public"."t_product_entity_map_iid_seq"
 ...
 START 43720
 CACHE 1;
SELECT setval('"public"."t_product_entity_map_iid_seq"', 43720, true);
...
CREATE SEQUENCE "public"."t_product_image_iid_seq"
 ...
 START 1066650
 CACHE 1;
SELECT setval('"public"."t_product_image_iid_seq"', 1066650, true);
...
CREATE SEQUENCE "public"."t_product_intercept_url_iid_seq"
 ...
 START 110
 CACHE 1;
SELECT setval('"public"."t_product_intercept_url_iid_seq"', 110, true);
...
CREATE SEQUENCE "public"."t_product_label_iid_seq"
 ...
 START 2956221
 CACHE 1;
SELECT setval('"public"."t_product_label_iid_seq"', 2956221, true);
...
CREATE SEQUENCE "public"."t_product_label_type_iid_seq"
 ...
 START 7
 CACHE 1;
SELECT setval('"public"."t_product_label_type_iid_seq"', 7, true);
...
CREATE SEQUENCE "public"."t_product_multiattribute_attribute_iid_seq"
 ...
 START 8826
 CACHE 1;
SELECT setval('"public"."t_product_multiattribute_attribute_iid_seq"', 8826, true);
...
CREATE SEQUENCE "public"."t_product_multiattribute_base_iid_seq"
 ...
 START 7572
 CACHE 1;
SELECT setval('"public"."t_product_multiattribute_base_iid_seq"', 7572, true);
...
CREATE SEQUENCE "public"."t_product_multiattribute_sku_iid_seq"
 ...
 START 30136
 CACHE 1;
SELECT setval('"public"."t_product_multiattribute_sku_iid_seq"', 30136, true);
...
CREATE SEQUENCE "public"."t_product_recommend_iid_seq"
 ...
 START 246306
 CACHE 1;
SELECT setval('"public"."t_product_recommend_iid_seq"', 246306, true);
...
CREATE SEQUENCE "public"."t_product_saleprice_iid_seq"
 ...
 START 84764
 CACHE 1;
SELECT setval('"public"."t_product_saleprice_iid_seq"', 84764, true);
...
CREATE SEQUENCE "public"."t_product_selling_points_iid_seq"
 ...
 START 272734
 CACHE 1;
SELECT setval('"public"."t_product_selling_points_iid_seq"', 272734, true);

-- ----------------------------
-- Sequence structure for t_product_storage_label_iid_seq
-- ----------------------------
DROP SEQUENCE "public"."t_product_storage_label_iid_seq";
CREATE SEQUENCE "public"."t_product_storage_label_iid_seq"
 INCREMENT 1
 MINVALUE 1
 MAXVALUE 9223372036854775807
 START 15967
 CACHE 1;
SELECT setval('"public"."t_product_storage_label_iid_seq"', 15967, true);
...
CREATE SEQUENCE "public"."t_product_storage_map_iid_seq"
 ...
 START 1187138
 CACHE 1;
SELECT setval('"public"."t_product_storage_map_iid_seq"', 1187138, true);
...
CREATE SEQUENCE "public"."t_product_topic_page_iid_seq"
 ...
 START 145
 CACHE 1;
SELECT setval('"public"."t_product_topic_page_iid_seq"', 145, true);
...
CREATE SEQUENCE "public"."t_product_translate_iid_seq"
 ...
 START 122713
 CACHE 1;
SELECT setval('"public"."t_product_translate_iid_seq"', 122713, true);
...
CREATE SEQUENCE "public"."t_product_url_iid_seq"
 ...
 START 88261
 CACHE 1;
SELECT setval('"public"."t_product_url_iid_seq"', 88261, true);
...
CREATE SEQUENCE "public"."t_product_video_iid_seq"
 ...
 START 9951
 CACHE 1;
SELECT setval('"public"."t_product_video_iid_seq"', 9951, true);
...
CREATE SEQUENCE "public"."t_rabbit_monitor_id_seq"
 ...
 START 156991
 CACHE 1;
SELECT setval('"public"."t_rabbit_monitor_id_seq"', 156991, true);
...
CREATE SEQUENCE "public"."t_third_platform_data_iid_seq"
 ...
 START 3651
 CACHE 1;
SELECT setval('"public"."t_third_platform_data_iid_seq"', 3651, true);
...
-- ----------------------------
-- Table structure for google_category_test
-- ----------------------------
DROP TABLE IF EXISTS "public"."google_category_test";
CREATE TABLE "public"."google_category_test" (
"iid" int4 DEFAULT nextval('t_category_base_iid_seq'::regclass) NOT NULL,
"iparentid" int4,
"cpath" varchar(255) COLLATE "default",
"google" varchar(500) COLLATE "default"
)
WITH (OIDS=FALSE)

;
COMMENT ON COLUMN "public"."google_category_test"."iid" IS '主键';
COMMENT ON COLUMN "public"."google_category_test"."iparentid" IS '父编号';
COMMENT ON COLUMN "public"."google_category_test"."cpath" IS '路径';
COMMENT ON COLUMN "public"."google_category_test"."google" IS '级别';

-- ----------------------------
-- Table structure for Sheet0
-- ----------------------------
DROP TABLE IF EXISTS "public"."Sheet0";
CREATE TABLE "public"."Sheet0" (
"9009e88c-d945-1004-89c8-fe4acbfc908f" varchar(255) COLLATE "default",
"L0249" varchar(255) COLLATE "default",
"28.46" varchar(255) COLLATE "default",
"2015-11-30 00:00:30" varchar(255) COLLATE "default",
"2016-2-28 00:00:00" varchar(255) COLLATE "default",
"atuo" varchar(255) COLLATE "default",
"G" varchar(255) COLLATE "default",
...
-- ----------------------------
-- Table structure for t_attribute_key_namev2
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_attribute_key_namev2";
CREATE TABLE "public"."t_attribute_key_namev2" (
"iid" int4 DEFAULT nextval('t_attribute_key_name_iid_seq'::regclass) NOT NULL,
"ikeyid" int4,
"ilanguageid" int4,
"ckeyname" varchar(50) COLLATE "default"
...
;
COMMENT ON TABLE "public"."t_attribute_key_namev2" IS '属性键名称表';
COMMENT ON COLUMN "public"."t_attribute_key_namev2"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_attribute_key_namev2"."ikeyid" IS '属性值编号';
COMMENT ON COLUMN "public"."t_attribute_key_namev2"."ilanguageid" IS '语言编号';
COMMENT ON COLUMN "public"."t_attribute_key_namev2"."ckeyname" IS '属性名';
...
-- ----------------------------
-- Table structure for t_attribute_value_namev2
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_attribute_value_namev2";
CREATE TABLE "public"."t_attribute_value_namev2" (
"ikeyid" int4 DEFAULT nextval('t_attribute_value_name_ikeyid_seq'::regclass) NOT NULL,
"ilanguageid" int4,
"ivalueid" int4,
"cvaluename" varchar(50) COLLATE "default"
...
;
COMMENT ON TABLE "public"."t_attribute_value_namev2" IS '属性值名称表';
COMMENT ON COLUMN "public"."t_attribute_value_namev2"."ikeyid" IS '主键';
COMMENT ON COLUMN "public"."t_attribute_value_namev2"."ilanguageid" IS '语言编号';
COMMENT ON COLUMN "public"."t_attribute_value_namev2"."ivalueid" IS '属性值编号';
COMMENT ON COLUMN "public"."t_attribute_value_namev2"."cvaluename" IS '属性值名称';

-- ----------------------------
-- Table structure for t_attribute_valuev2
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_attribute_valuev2";
CREATE TABLE "public"."t_attribute_valuev2" (
"ivalueid" int4 DEFAULT nextval('t_attribute_value_ivalueid_seq'::regclass) NOT NULL,
"ikeyid" int4 NOT NULL,
"ccreateuser" varchar(30) COLLATE "default",
"dcreatedate" timestamp(6) DEFAULT now()
)
WITH (OIDS=FALSE)
...
;
COMMENT ON TABLE "public"."t_attribute_valuev2" IS '属性值基础表';
COMMENT ON COLUMN "public"."t_attribute_valuev2"."ivalueid" IS '主键';
COMMENT ON COLUMN "public"."t_attribute_valuev2"."ikeyid" IS '属性键编号';
COMMENT ON COLUMN "public"."t_attribute_valuev2"."ccreateuser" IS '创建人';
COMMENT ON COLUMN "public"."t_attribute_valuev2"."dcreatedate" IS '创建时间';

-- ----------------------------
-- Table structure for t_category_attributekey_relation
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_category_attributekey_relation";
CREATE TABLE "public"."t_category_attributekey_relation" (
"iid" int4 DEFAULT nextval('t_category_attributekey_relation_iid_seq'::regclass) NOT NULL,
"icategoryid" int4,
"iattributekeyid" int4,
"isort" int4,
"bisshow" bool DEFAULT true
)
WITH (OIDS=FALSE)

;
COMMENT ON TABLE "public"."t_category_attributekey_relation" IS '品类属性过滤表';
COMMENT ON COLUMN "public"."t_category_attributekey_relation"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_category_attributekey_relation"."icategoryid" IS '品类编号';
COMMENT ON COLUMN "public"."t_category_attributekey_relation"."iattributekeyid" IS '属性编号';
COMMENT ON COLUMN "public"."t_category_attributekey_relation"."isort" IS '排序号';
COMMENT ON COLUMN "public"."t_category_attributekey_relation"."bisshow" IS '是否显示';
...
"iid" int4,
"icategoryid" int4 NOT NULL,
"iattributekeyid" int4 NOT NULL,
"iattributevalueid" int4 NOT NULL,
"isort" int4 DEFAULT 0,
"bisshow" bool DEFAULT true
)
WITH (OIDS=FALSE)

;
COMMENT ON COLUMN "public"."t_category_filter_attribute"."isort" IS '排序号';
COMMENT ON COLUMN "public"."t_category_filter_attribute"."bisshow" IS '是否显示';

-- ----------------------------
-- Table structure for t_category_filter_attribute_tmp
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_category_filter_attribute_tmp";
CREATE TABLE "public"."t_category_filter_attribute_tmp" (
"iid" int4,
"icategoryid" int4,
"iattributekeyid" int4,
...
"upddate" timestamp(6) DEFAULT '2015-09-14 02:39:34.420249'::timestamp without time zone,
"type" int4,
"storagename" varchar(32) COLLATE "default",
"labeltype" varchar(32) COLLATE "default",
"pushdate" timestamp(6)
)
WITH (OIDS=FALSE)
...
COMMENT ON COLUMN "public"."t_category_product_recommend"."type" IS '类型';
COMMENT ON COLUMN "public"."t_category_product_recommend"."storagename" IS '仓库ID';
COMMENT ON COLUMN "public"."t_category_product_recommend"."labeltype" IS '标签类型ID';
COMMENT ON COLUMN "public"."t_category_product_recommend"."pushdate" IS '推送至搜索引擎时间';
...
"istorageid" int4 DEFAULT 1 NOT NULL
)
WITH (OIDS=FALSE)
...
COMMENT ON COLUMN "public"."t_product_base"."flength" IS '商品的长';
COMMENT ON COLUMN "public"."t_product_base"."fwidth" IS '商品的宽';
COMMENT ON COLUMN "public"."t_product_base"."fheight" IS '商品的高';
COMMENT ON COLUMN "public"."t_product_base"."fvolumeweight" IS '商品的体积重';

-- ----------------------------
-- Table structure for t_product_base_160524
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_base_160524";
CREATE TABLE "public"."t_product_base_160524" (
"iid" int4,
"clistingid" varchar(50) COLLATE "default",
"iwebsiteid" int4,
"csku" varchar(40) COLLATE "default",
...
-- ----------------------------
-- Table structure for t_product_category_id_20160329
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_category_id_20160329";
CREATE TABLE "public"."t_product_category_id_20160329" (
"clistingid" varchar(40) COLLATE "default",
"icategory" int4
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for t_product_entity_mapv2
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_entity_mapv2";
CREATE TABLE "public"."t_product_entity_mapv2" (
"iid" int4 DEFAULT nextval('t_product_entity_map_iid_seq'::regclass) NOT NULL,
"clistingid" varchar(40) COLLATE "default",
"csku" varchar(30) COLLATE "default",
"ikey" int4,
...
;
COMMENT ON TABLE "public"."t_product_entity_mapv2" IS '产品自定义属性表';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."clistingid" IS '广告编号';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."csku" IS 'SKU';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."ikey" IS '属性键';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."ivalue" IS '属性值';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."iwebsiteid" IS '站点';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."bshow" IS '是否产品页显示';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."multiattribute" IS '是否为SKU属性  true是SKU属性，否则为SPU属性';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."ccreateuser" IS '创建人';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."dcreatedate" IS '创建时间';
COMMENT ON COLUMN "public"."t_product_entity_mapv2"."displaytype" IS '属性展示方式 1：文本 2：色块 3：图片';
...
"coriginalurl" varchar(600) COLLATE "default",
"bfetch" bool DEFAULT false,
"ihttpstatuscode" int4 DEFAULT 0,
"bclip" bool DEFAULT false
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for t_product_image1
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_image1";
CREATE TABLE "public"."t_product_image1" (
"iid" int4 DEFAULT nextval('t_product_image_iid_seq'::regclass) NOT NULL,
"clistingid" varchar(40) COLLATE "default",
"csku" varchar(30) COLLATE "default",
"cimageurl" varchar(600) COLLATE "default",
...
;
COMMENT ON TABLE "public"."t_product_image1" IS '产品图片表';
COMMENT ON COLUMN "public"."t_product_image1"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_product_image1"."clistingid" IS '广告编号';
COMMENT ON COLUMN "public"."t_product_image1"."csku" IS 'SKU';
COMMENT ON COLUMN "public"."t_product_image1"."cimageurl" IS '图片路径';
COMMENT ON COLUMN "public"."t_product_image1"."clabel" IS '图片label';
COMMENT ON COLUMN "public"."t_product_image1"."iorder" IS '图片排序';
COMMENT ON COLUMN "public"."t_product_image1"."bthumbnail" IS '是否缩略图';
COMMENT ON COLUMN "public"."t_product_image1"."bsmallimage" IS '是否小图';
COMMENT ON COLUMN "public"."t_product_image1"."bshowondetails" IS '是否显示在产品详情页面';
...
-- ----------------------------
-- Table structure for t_product_jump_url
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_jump_url";
CREATE TABLE "public"."t_product_jump_url" (
"oiid" int4,
"piid" int4,
"iwebsiteid" int4,
"clistingid" varchar(64) COLLATE "default",
...
"ilanguageid" int4,
"itype" int4,
"old_url" varchar(512) COLLATE "default",
"new_url" varchar(512) COLLATE "default",
"dcreatedate" timestamp(6) DEFAULT now(),
"field1" varchar(64) COLLATE "default" DEFAULT ''::character varying,
"field2" varchar(64) COLLATE "default" DEFAULT ''::character varying,
"field3" varchar(64) COLLATE "default" DEFAULT ''::character varying,
"field4" varchar(64) COLLATE "default" DEFAULT ''::character varying,
"field5" varchar(64) COLLATE "default" DEFAULT ''::character varying
)
WITH (OIDS=FALSE)

;
COMMENT ON TABLE "public"."t_product_jump_url" IS '301跳转url表';
COMMENT ON COLUMN "public"."t_product_jump_url"."oiid" IS '原iid';
COMMENT ON COLUMN "public"."t_product_jump_url"."piid" IS 'produc_base id';
COMMENT ON COLUMN "public"."t_product_jump_url"."iwebsiteid" IS '站点编号';
COMMENT ON COLUMN "public"."t_product_jump_url"."clistingid" IS 'listingId';
COMMENT ON COLUMN "public"."t_product_jump_url"."icategoryid" IS '类目';
COMMENT ON COLUMN "public"."t_product_jump_url"."ilanguageid" IS '语言';
COMMENT ON COLUMN "public"."t_product_jump_url"."itype" IS '类型 1:商品 2:类目';
COMMENT ON COLUMN "public"."t_product_jump_url"."old_url" IS '老url';
COMMENT ON COLUMN "public"."t_product_jump_url"."new_url" IS '新url';
COMMENT ON COLUMN "public"."t_product_jump_url"."dcreatedate" IS '创建时间';
COMMENT ON COLUMN "public"."t_product_jump_url"."field1" IS '扩展字段1';
COMMENT ON COLUMN "public"."t_product_jump_url"."field2" IS '扩展字段2';
COMMENT ON COLUMN "public"."t_product_jump_url"."field3" IS '扩展字段3';
COMMENT ON COLUMN "public"."t_product_jump_url"."field4" IS '扩展字段4';
COMMENT ON COLUMN "public"."t_product_jump_url"."field5" IS '扩展字段5';
...
-- ----------------------------
-- Table structure for t_product_label_typev2
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_label_typev2";
CREATE TABLE "public"."t_product_label_typev2" (
"id" int4 DEFAULT nextval('t_product_label_type_iid_seq'::regclass) NOT NULL,
"label_name" varchar(50) COLLATE "default" NOT NULL,
"create_user" varchar(20) COLLATE "default",
"website_id" int4 NOT NULL,
"label_type" int4 DEFAULT 1 NOT NULL,
"create_tm" date,
"update_tm" date,
...
;
COMMENT ON TABLE "public"."t_product_label_typev2" IS '产品标签类型';
COMMENT ON COLUMN "public"."t_product_label_typev2"."id" IS '主键';
COMMENT ON COLUMN "public"."t_product_label_typev2"."label_name" IS '标签名称';
COMMENT ON COLUMN "public"."t_product_label_typev2"."create_user" IS '创建人';
COMMENT ON COLUMN "public"."t_product_label_typev2"."website_id" IS '站点';
COMMENT ON COLUMN "public"."t_product_label_typev2"."label_type" IS '标签类型 1：产品标签  2：仓库标签';
...
COMMENT ON COLUMN "public"."t_product_saleprice"."istorageid" IS '仓库编号';

-- ----------------------------
-- Table structure for t_product_saleprice_xxxxxxxxxxxxxx
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_saleprice_xxxxxxxxxxxxxx";
CREATE TABLE "public"."t_product_saleprice_xxxxxxxxxxxxxx" (
"iid" int4,
"clistingid" varchar(40) COLLATE "default",
"csku" varchar(30) COLLATE "default",
"fsaleprice" float8,
...
-- ----------------------------
-- Table structure for t_product_storage_label
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_storage_label";
CREATE TABLE "public"."t_product_storage_label" (
"iid" int4 DEFAULT nextval('t_product_storage_label_iid_seq'::regclass) NOT NULL,
"iwebsiteid" int4,
"ctype" varchar(32) COLLATE "default",
"clistingid" varchar(64) COLLATE "default",
"ccreateuser" varchar(32) COLLATE "default",
"dcreatedate" timestamp(6) DEFAULT now(),
"istorageid" int4
)
WITH (OIDS=FALSE)
...
;
COMMENT ON TABLE "public"."t_product_storage_label" IS '仓库标签表';
COMMENT ON COLUMN "public"."t_product_storage_label"."iid" IS '主键id';
COMMENT ON COLUMN "public"."t_product_storage_label"."iwebsiteid" IS '站点编号';
COMMENT ON COLUMN "public"."t_product_storage_label"."ctype" IS '标签名称';
COMMENT ON COLUMN "public"."t_product_storage_label"."clistingid" IS '别名';
COMMENT ON COLUMN "public"."t_product_storage_label"."ccreateuser" IS '创建人';
COMMENT ON COLUMN "public"."t_product_storage_label"."dcreatedate" IS '创建时间';
COMMENT ON COLUMN "public"."t_product_storage_label"."istorageid" IS '仓库id';
...
"dcreatedate" timestamp(6) DEFAULT now(),
"bavailable" bool DEFAULT true,
"ilogisticstemplateid" int4 DEFAULT (-1),
"istatus" int4,
"iqty" int4,
"fprice" float8
)
...
COMMENT ON COLUMN "public"."t_product_storage_map"."ilogisticstemplateid" IS '物流模板id';
COMMENT ON COLUMN "public"."t_product_storage_map"."istatus" IS '状态(在售、停售、下架)';
COMMENT ON COLUMN "public"."t_product_storage_map"."iqty" IS '数量';
COMMENT ON COLUMN "public"."t_product_storage_map"."fprice" IS '价格';
...
"cdescription" varchar(60000) COLLATE "default",
...
-- ----------------------------
-- Table structure for t_product_url_20160329
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_url_20160329";
CREATE TABLE "public"."t_product_url_20160329" (
"clistingid" varchar(40) COLLATE "default",
"curl" varchar(500) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for t_product_url_201606151419
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_url_201606151419";
CREATE TABLE "public"."t_product_url_201606151419" (
"iid" int4 DEFAULT nextval('t_product_url_iid_seq'::regclass) NOT NULL,
"clistingid" varchar(40) COLLATE "default",
"csku" varchar(30) COLLATE "default",
"ilanguageid" int4,
...
;
COMMENT ON TABLE "public"."t_product_url_201606151419" IS '产品详情页路由表';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."clistingid" IS '广告编号';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."csku" IS 'SKU';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."ilanguageid" IS '语言编号';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."curl" IS '路由地址';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."ccreateuser" IS '创建人';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."dcreatedate" IS '创建时间';
COMMENT ON COLUMN "public"."t_product_url_201606151419"."iwebsiteid" IS '站点编号';

-- ----------------------------
-- Table structure for t_product_url_copy_0615
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_url_copy_0615";
CREATE TABLE "public"."t_product_url_copy_0615" (
"iid" int4 DEFAULT nextval('t_product_url_iid_seq'::regclass) NOT NULL,
"clistingid" varchar(40) COLLATE "default",
"csku" varchar(30) COLLATE "default",
"ilanguageid" int4,
...
;
COMMENT ON TABLE "public"."t_product_url_copy_0615" IS '产品详情页路由表';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."iid" IS '主键';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."clistingid" IS '广告编号';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."csku" IS 'SKU';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."ilanguageid" IS '语言编号';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."curl" IS '路由地址';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."ccreateuser" IS '创建人';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."dcreatedate" IS '创建时间';
COMMENT ON COLUMN "public"."t_product_url_copy_0615"."iwebsiteid" IS '站点编号';

-- ----------------------------
-- Table structure for t_product_url_recover_20160621
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_product_url_recover_20160621";
CREATE TABLE "public"."t_product_url_recover_20160621" (
"clistingid_1" varchar(50) COLLATE "default",
"ilanguageid_1" int4,
"curl" text COLLATE "default"
)
WITH (OIDS=FALSE)
...
"node_data" varchar(150000) COLLATE "default",
...
-- ----------------------------
-- Table structure for temp_a
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_a";
CREATE TABLE "public"."temp_a" (
"listingid" varchar(100) COLLATE "default",
"old" varchar(255) COLLATE "default",
"new" varchar(255) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for temp_k3
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_k3";
CREATE TABLE "public"."temp_k3" (
...
-- ----------------------------
-- Table structure for temp_k4
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_k4";
CREATE TABLE "public"."temp_k4" (
"id" text COLLATE "default",
"cparentsku" varchar(40) COLLATE "default",
"clistingid" varchar(50) COLLATE "default",
"ikey" int4,
...
-- ----------------------------
-- Table structure for temp_parentsku
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_parentsku";
CREATE TABLE "public"."temp_parentsku" (
"cparentsku" varchar(40) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for temp_parentsku1
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_parentsku1";
CREATE TABLE "public"."temp_parentsku1" (
"cparentsku" varchar(50) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for temp_v1
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_v1";
CREATE TABLE "public"."temp_v1" (
"clistingid" varchar(50) COLLATE "default",
"cparentsku" varchar(40) COLLATE "default",
"ikey" int4
)
...
-- ----------------------------
-- Table structure for temp_v5
-- ----------------------------
DROP TABLE IF EXISTS "public"."temp_v5";
CREATE TABLE "public"."temp_v5" (
"clistingid" varchar(50) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for tmp_attribute
-- ----------------------------
DROP TABLE IF EXISTS "public"."tmp_attribute";
CREATE TABLE "public"."tmp_attribute" (
"ilanguage" int4 NOT NULL,
"ilevel" int4 NOT NULL,
"ikey" int4 NOT NULL,
"cvalue" varchar(500) COLLATE "default"
)
WITH (OIDS=FALSE)
...
-- ----------------------------
-- Table structure for tmp_sku
-- ----------------------------
DROP TABLE IF EXISTS "public"."tmp_sku";
CREATE TABLE "public"."tmp_sku" (
"csku" varchar(40) COLLATE "default"
)
WITH (OIDS=FALSE)
...
ALTER SEQUENCE "public"."t_category_attributekey_relation_iid_seq" OWNED BY "t_category_attributekey_relation"."iid";
...
ALTER SEQUENCE "public"."t_product_storage_label_iid_seq" OWNED BY "t_product_storage_label"."iid";
...
ALTER SEQUENCE "public"."t_product_url_iid_seq" OWNED BY "t_product_url_201606151419"."iid";
...
-- ----------------------------
-- Primary Key structure for table google_category_test
-- ----------------------------
ALTER TABLE "public"."google_category_test" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
-- Indexes structure for table t_attribute_key_namev2
-- ----------------------------
CREATE INDEX "index_key_namev2_ikeyid" ON "public"."t_attribute_key_namev2" USING btree (ikeyid);
CREATE INDEX "index_key_namev2_ikeyid_ivalueid" ON "public"."t_attribute_key_namev2" USING btree (ikeyid, ilanguageid);

-- ----------------------------
-- Primary Key structure for table t_attribute_key_namev2
-- ----------------------------
ALTER TABLE "public"."t_attribute_key_namev2" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
-- Indexes structure for table t_attribute_value_namev2
-- ----------------------------
CREATE INDEX "index_value_namev2_ikeyid" ON "public"."t_attribute_value_namev2" USING btree (ikeyid);
CREATE INDEX "index_value_namev2_ikeyid_ivalueid" ON "public"."t_attribute_value_namev2" USING btree (ikeyid, ivalueid, ilanguageid);
CREATE INDEX "index_value_namev2_ivalueid" ON "public"."t_attribute_value_namev2" USING btree (ivalueid);

-- ----------------------------
-- Primary Key structure for table t_attribute_value_namev2
-- ----------------------------
ALTER TABLE "public"."t_attribute_value_namev2" ADD PRIMARY KEY ("ikeyid");

-- ----------------------------
-- Indexes structure for table t_attribute_valuev2
-- ----------------------------
CREATE INDEX "index_ikeyid" ON "public"."t_attribute_valuev2" USING btree (ikeyid);
CREATE INDEX "index_ikeyid_ivalueid" ON "public"."t_attribute_valuev2" USING btree (ikeyid, ivalueid);
CREATE INDEX "index_ivalueid" ON "public"."t_attribute_valuev2" USING btree (ivalueid);

-- ----------------------------
-- Uniques structure for table t_attribute_valuev2
-- ----------------------------
ALTER TABLE "public"."t_attribute_valuev2" ADD UNIQUE ("ivalueid", "ikeyid");

-- ----------------------------
-- Indexes structure for table t_category_attributekey_relation
-- ----------------------------
CREATE INDEX "index_t_category_attributekey_relation_icategoryid" ON "public"."t_category_attributekey_relation" USING btree (icategoryid);

-- ----------------------------
-- Primary Key structure for table t_category_attributekey_relation
-- ----------------------------
ALTER TABLE "public"."t_category_attributekey_relation" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
-- Indexes structure for table t_category_base
-- ----------------------------
CREATE INDEX "t_category_base_cpath" ON "public"."t_category_base" USING btree (cpath);
...
-- ----------------------------
-- Indexes structure for table t_category_filter_attribute
-- ----------------------------
CREATE INDEX "index_t_category_filter_attribute_icategoryid_keyid" ON "public"."t_category_filter_attribute" USING btree (icategoryid, iattributekeyid);

-- ----------------------------
-- Primary Key structure for table t_category_filter_attribute
-- ----------------------------
ALTER TABLE "public"."t_category_filter_attribute" ADD PRIMARY KEY ("icategoryid", "iattributekeyid", "iattributevalueid");
...
-- ----------------------------
-- Indexes structure for table t_category_product_recommend
-- ----------------------------
CREATE INDEX "index_t_category_product_recommend_1" ON "public"."t_category_product_recommend" USING btree (status, iwebsiteid, sku);
...
-- ----------------------------
-- Indexes structure for table t_category_website
-- ----------------------------
CREATE INDEX "index_t_category_website_icategoryid" ON "public"."t_category_website" USING btree (iwebsiteid, iparentid);
...
CREATE UNIQUE INDEX "idx_sku_merchants_product" ON "public"."t_merchants_product" USING btree (csku);
...
-- ----------------------------
CREATE INDEX "idx_productbase_iwebsiteid" ON "public"."t_product_base" USING hash (iwebsiteid);
CREATE UNIQUE INDEX "idx_productbase_listing" ON "public"."t_product_base" USING btree (clistingid);
CREATE INDEX "index_clistingid" ON "public"."t_product_base" USING btree (clistingid);
...
-- ----------------------------
-- Primary Key structure for table t_product_entity_mapv2
-- ----------------------------
ALTER TABLE "public"."t_product_entity_mapv2" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
CREATE INDEX "idx_productimage_csku" ON "public"."t_product_image" USING btree (csku);
...
-- ----------------------------
-- Indexes structure for table t_product_image1
-- ----------------------------
CREATE INDEX "idx_productimage_csku_copy" ON "public"."t_product_image1" USING btree (csku);
CREATE INDEX "idx_productimage_listing_copy" ON "public"."t_product_image1" USING btree (clistingid);

-- ----------------------------
-- Primary Key structure for table t_product_image1
-- ----------------------------
ALTER TABLE "public"."t_product_image1" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
-- Indexes structure for table t_product_jump_url
-- ----------------------------
CREATE INDEX "idx_oiid" ON "public"."t_product_jump_url" USING btree (oiid);
CREATE INDEX "index_t_product_jump_url_1" ON "public"."t_product_jump_url" USING btree (clistingid, iwebsiteid);
...
-- ----------------------------
-- Primary Key structure for table t_product_label_typev2
-- ----------------------------
ALTER TABLE "public"."t_product_label_typev2" ADD PRIMARY KEY ("id");
...
-- ----------------------------
-- Indexes structure for table t_product_multiattribute_sku
-- ----------------------------
CREATE INDEX "index_t_product_multiattribute_sku_1" ON "public"."t_product_multiattribute_sku" USING btree (cparentsku);
...
-- ----------------------------
-- Indexes structure for table t_product_saleprice
-- ----------------------------
CREATE INDEX "idx_product_saleprice_clistingid" ON "public"."t_product_saleprice" USING btree (clistingid);
CREATE INDEX "idx_product_saleprice_istorageid" ON "public"."t_product_saleprice" USING btree (istorageid);
...
-- ----------------------------
-- Indexes structure for table t_product_storage_label
-- ----------------------------
CREATE INDEX "index_t_product_storage_label_1" ON "public"."t_product_storage_label" USING btree (iwebsiteid, clistingid, istorageid);

-- ----------------------------
-- Primary Key structure for table t_product_storage_label
-- ----------------------------
ALTER TABLE "public"."t_product_storage_label" ADD PRIMARY KEY ("iid");

-- ----------------------------
-- Indexes structure for table t_product_storage_map
-- ----------------------------
CREATE INDEX "index_clistingid_storagemap" ON "public"."t_product_storage_map" USING btree (clistingid);
CREATE INDEX "index_listingid_storageid" ON "public"."t_product_storage_map" USING btree (clistingid, istorageid);
...
-- ----------------------------
CREATE INDEX "idx_producturl_url_copy" ON "public"."t_product_url" USING btree (curl);
...
-- ----------------------------
-- Indexes structure for table t_product_url_201606151419
-- ----------------------------
CREATE INDEX "idx_producturl_url" ON "public"."t_product_url_201606151419" USING btree (curl);

-- ----------------------------
-- Primary Key structure for table t_product_url_201606151419
-- ----------------------------
ALTER TABLE "public"."t_product_url_201606151419" ADD PRIMARY KEY ("iid");

-- ----------------------------
-- Indexes structure for table t_product_url_copy_0615
-- ----------------------------
CREATE INDEX "idx_producturl_url_copy_copy" ON "public"."t_product_url_copy_0615" USING btree (curl);

-- ----------------------------
-- Uniques structure for table t_product_url_copy_0615
-- ----------------------------
ALTER TABLE "public"."t_product_url_copy_0615" ADD UNIQUE ("curl", "ilanguageid", "iwebsiteid");

-- ----------------------------
-- Primary Key structure for table t_product_url_copy_0615
-- ----------------------------
ALTER TABLE "public"."t_product_url_copy_0615" ADD PRIMARY KEY ("iid");
...
-- ----------------------------
-- Indexes structure for table t_rabbit_monitor
-- ----------------------------
CREATE INDEX "index_record_state" ON "public"."t_rabbit_monitor" USING btree (record_state);
CREATE INDEX "index_recordkey" ON "public"."t_rabbit_monitor" USING btree (record_key);
...
-- ----------------------------
-- Primary Key structure for table tmp_attribute
-- ----------------------------
ALTER TABLE "public"."tmp_attribute" ADD PRIMARY KEY ("ilanguage", "ilevel", "ikey");
